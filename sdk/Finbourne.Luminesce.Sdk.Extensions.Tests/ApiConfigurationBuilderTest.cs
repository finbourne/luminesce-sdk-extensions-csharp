...
namespace Finbourne.Luminesce.Sdk.Extensions.Tests
{
    ...
    public class ApiConfigurationBuilderTest
    {
        ...
        private string _cachedLuminesceUrl;
        ...
        public void Setup()
        {
            ...
            _cachedLuminesceUrl = Environment.GetEnvironmentVariable($"FBN_{APP}_API_URL") ??
        ...
        public void TearDown()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", _cachedLuminesceUrl);
        ...
        public void Use_Secrets_File_If_It_Exists()
        {
            PopulateDummySecretsFile(new Dictionary<string, string>
            {
                ...
                {"luminesceUrl", string.Format("<{0}Url>", "luminesce")},
            });            
            ...
            Assert.That(apiConfiguration.LuminesceUrl, Is.EqualTo(string.Format("<{0}Url>", "luminesce")));            
        }
        [Test]
        ...
        public void Use_Environment_Variables_If_No_Secrets_File_Provided()
        {
            ...
            Environment.SetEnvironmentVariable($"FBN_{APP}_API_URL", string.Format("<env.{0}Url>", "luminesce"));
            ...
            Assert.That(apiConfiguration.LuminesceUrl, Is.EqualTo(string.Format("<env.{0}Url>", "luminesce")));            
        }
        [Test]
        ...
        public void Use_Configuration_Section_If_Supplied()
        {
            var settings = new Dictionary<string, string>
            {
                ...
                { "api:LuminesceUrl", string.Format("<env.{0}Url>", "luminesce") },
        ...
        public void Throw_Exception_If_Configuration_Section_Incomplete()
        {
            ...
            {
                { "api:TokenUrl", "<tokenUrl>" },
                { "api:LuminesceUrl", string.Format("<{0}Url>", "luminesce") },
                { "api:ClientId", "<clientId>" },
                { "api:ClientSecret", "" },
                { "api:Username", "<username>" },
                { "api:Password", "" },
